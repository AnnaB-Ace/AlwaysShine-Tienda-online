...
const MyButton = (prop) => {
    const {label = 'my button', onClick, disabled, type = 'primary', buttonType = '', loading } = prop;
    ...
    return (
        ...
        <button type={buttonType} className={`button ${getClass()}`} onClick={onClick} disabled={disabled}>    
